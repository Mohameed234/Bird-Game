...
function play(){
        ...
        pipe_sprite.forEach((element) => {
            ...
            if(pipe_sprite_props.right <= 0){
                ...
                if (bird_props.left < pipe_sprite_props.left + pipe_sprite_props.width &&
                    ...
                    game_state ='End';
                    massage.innerHTML = 'Game Over'.fontcolor('red') + '<br/> Press Enter To Restart';
                    massage.classList.add('massageStyle');
                    img.style.display = 'none';
                    return;
    ...
    function apply_gravity(){
        ...
        if(bird_props.top <= 0 || bird_props >= background.bottom){
            game_state = 'End';
            massage.style.left = '20vw';
